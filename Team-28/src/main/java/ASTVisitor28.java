...
/** Visitor class which provides methods to visit ASTNode **/
public class ASTVisitor28 extends ASTVisitor {
	private List<ASTNode> astNodes; // List of nodes in order of their discovery

	/**
	 * Default Constructor for the ASTVisitor28
	 */
	public ASTVisitor28() {
		super();
	 ...
	 * considered part of main structure of the AST. This method will only be
	 * called if a client goes out of their way to visit this kind of node
	 * explicitly.
	 * </p>
	 *
	 * @param node
	 ...
	 * implementation is controlled by a constructor-supplied parameter which is
